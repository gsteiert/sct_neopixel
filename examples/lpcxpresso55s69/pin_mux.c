...
void BOARD_InitPins(void)
{
    ...
    const uint32_t NEOPIXEL_CFG = (/* Pin is configured as SCT0_OUT3 */
                               IOCON_PIO_FUNC4 |
                               /* Selects pull-up function */
                               IOCON_PIO_MODE_PULLUP |
                               /* Standard mode, output slew rate control is enabled */
                               ...
                               /* Open drain is disabled */
                               IOCON_PIO_OPENDRAIN_DI);
    /* PORT1 PIN10 (coords: 1) is configured as SCT0_OUT3 */
    IOCON_PinMuxSet(IOCON, BOARD_NEOPIXEL_PORT, BOARD_NEOPIXEL_PIN, NEOPIXEL_CFG);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
